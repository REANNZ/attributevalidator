    ...
    <div class="row">
      <div class="span12">
        ...
        <div class="hero-unit">
            ...
            <p>
              This service will validate the atrributes provided about you from your identity provider ensuring they are provided in a format that is suitable for consumption by Tuakiri connected services.
            </p>
            <p>
