<%@ page contentType="text/html"%>
  ...
  An important task <strong>requiring your approval</strong> is waiting for your input within <g:link controller="workflowApproval" action="list" absolute="true">XYZ workflows</g:link>.
  <br><br>
